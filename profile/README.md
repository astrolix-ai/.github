...
![Syzygy clipboard workbench](../screenshot/clipboard.image.dark.en.png)
...
| | | |
| :---: | :---: | :---: |
| ![Devices](../screenshot/device.all.dark.en.png) | ![Popup](../screenshot/popup.image.light.en.png) | ![Command palette](../screenshot/command.palette.dark.en.png) |
| **Devices** — one encrypted mesh | **Popup** — pin any clip on top | **Command palette** — every action, one keystroke |
| ![Search](../screenshot/search.filter.light.en.png) | ![Editor](../screenshot/editor.light.en.png) | ![Voice](../screenshot/voice.dicate.dark.en.png) |
...
| | | |
| :---: | :---: | :---: |
| ![插件与快捷键](../screenshot/plugin.shortcut.light.en.png) | ![智能标签](../screenshot/tag.light.en.png) | ![主题](../screenshot/setting.theme.dark.en.png) |
| **插件与快捷键** —— 全局热键随心配 | **智能标签** —— 手动 / AI 自动归类 | **主题** —— 深浅色随你切换 |
| ![更新器](../screenshot/setting.updater.light.en.png) | ![关于](../screenshot/setting.about.en.png) | ![Prompts](../screenshot/prompt.all.dark.en.png) |
